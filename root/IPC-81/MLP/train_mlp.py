...
if __name__ == "__main__":
    try:
        ...
        print(f"  Test Set - MSE: {results['default_train']['MSE']:.4f}, RMSE: {results['default_test']['RMSE']:.4f}, MAE: {results['default_test']['MAE']:.4f}, R²: {results['default_test']['R2']:.4f}, MRE: {results['default_test']['MRE']:.4f}")
